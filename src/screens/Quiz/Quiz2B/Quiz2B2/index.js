...
export default function App() {
    ...
    const respostas = ['Patrimônio líquido', 
        'Entradas e saídas', 
        'Lucratividade e prejuízo',
        'Ativos e passivos'];
    ...
    const proximapergunta = async () => {
        if (respostax.isCorrect) {
            ...
            navigation.navigate('Quiz2B3');
        } else {
            Alert.alert(
                'Resposta Incorreta',
                `A resposta correta é: ${respostas[respostaCorreta]}`,
                [
                    { text: 'Próxima Pergunta', onPress: () => navigation.navigate('Quiz2B3') }
                ]
            );
        }
    };
    ...
    return (
        <StyledView>
            ...
            <PerguntaV
                pergunta="Qual a função da demonstração de resultados?"
