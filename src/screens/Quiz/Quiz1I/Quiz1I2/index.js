...
export default function App() {
    ...
    const respostas = ['O patrocinador é responsável apenas pelo financiamento', 
        'O patrocinador lidera a equipe de projeto e toma todas as decisões importantes', 
        'O patrocinador fornece suporte e recursos, influenciando o sucesso do projeto',
        'O patrocinador não desempenha um papel significativo na gestão de projetos'];
    ...
    const proximapergunta = async () => {
        if (respostax.isCorrect) {
            ...
            navigation.navigate('Quiz1I3');
        } else {
            Alert.alert(
                'Resposta Incorreta',
                `A resposta correta é: ${respostas[respostaCorreta]}`,
                [
                    { text: 'Próxima Pergunta', onPress: () => navigation.navigate('Quiz1I3') }
                ]
            );
        }
    };
    ...
    return (
        <StyledView>
            ...
            <PerguntaV
                pergunta="Qual é o papel de um patrocinador de projeto?"
